package com.mob.app.modules.engcarpmafour.`data`.model

import com.mob.app.R
import com.mob.app.appcomponents.di.MyApp
import kotlin.String

data class EngcarpmafourModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txt4X4: String? = MyApp.getInstance().resources.getString(R.string.lbl_4_x_4)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txt4X5: String? = MyApp.getInstance().resources.getString(R.string.lbl_4_x_5)
  ,
  /**
   * TODO Replace with dynamic value
   */
